...
class CustomDropdownLite extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isClearVisible = selectedItem != null;
    ...
    return DropdownSearch<String>(
      ...
      clearButtonProps: ClearButtonProps(
        ...
        icon: Icon(
          Icons.close,
          size: context.iconSize(size: IconSize.small) * 0.75,
